...
import com.feywild.feywild.world.dimension.feywild.setup.BiomeTemplates;
...
public class BiomeConfiguration {
    ...
    private SurfaceRules.RuleSource surface = normalFeywildSurface(Blocks.GRASS_BLOCK, Blocks.DIRT);

    public BiomeConfiguration() {

    }

    public BiomeConfiguration(BiomeTemplate template) {
        template.action.accept(this);
    }

    public static SurfaceRules.RuleSource normalFeywildSurface(Block top, Block below) {
        return normalFeywildSurface(top.defaultBlockState(), below.defaultBlockState());
    }

    public static SurfaceRules.RuleSource normalFeywildSurface(BlockState top, BlockState below) {
    ...
    public BiomeConfiguration surface(Block top, Block below) {
        return this.surface(normalFeywildSurface(top, below));
    }
    ...
    public enum BiomeTemplate {
        ...
        BiomeTemplate(Consumer<BiomeConfiguration> action) {
            this.action = action;
        }
    }
}
