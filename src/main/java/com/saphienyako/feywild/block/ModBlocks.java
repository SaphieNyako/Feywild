...
public class ModBlocks {
    ...
    //MUSHROOM BLOCKS
    public static final RegistryObject<Block> ORANGE_MUSHROOM =
            registerBlockAndItem("orange_mushroom",
                    () -> new MushroomBlock(
                            ...
                            () -> ModConfiguredFeatures.ORANGE_MUSHROOM.getHolder().get()
                    ));

    public static final RegistryObject<Block> YELLOW_MUSHROOM =
            registerBlockAndItem("yellow_mushroom",
                    () -> new MushroomBlock(
                            BlockBehaviour.Properties.copy(Blocks.RED_MUSHROOM)
                                    .noCollission()
                                    .randomTicks()
                                    .instabreak()
                                    .sound(SoundType.GRASS),
                            () -> ModConfiguredFeatures.YELLOW_MUSHROOM.getHolder().get()
                    ));

    public static final RegistryObject<Block> GREEN_MUSHROOM =
            registerBlockAndItem("green_mushroom",
                    () -> new MushroomBlock(
                            BlockBehaviour.Properties.copy(Blocks.RED_MUSHROOM)
                                    .noCollission()
                                    .randomTicks()
                                    .instabreak()
                                    .sound(SoundType.GRASS),
                            () -> ModConfiguredFeatures.GREEN_MUSHROOM.getHolder().get()
                    ));

    public static final RegistryObject<Block> LIGHT_BLUE_MUSHROOM =
            registerBlockAndItem("light_blue_mushroom",
                    () -> new MushroomBlock(
                            BlockBehaviour.Properties.copy(Blocks.RED_MUSHROOM)
                                    .noCollission()
                                    .randomTicks()
                                    .instabreak()
                                    .sound(SoundType.GRASS),
                            () -> ModConfiguredFeatures.LIGHT_BLUE_MUSHROOM.getHolder().get()
                    ));

    public static final RegistryObject<Block> BLUE_MUSHROOM =
            registerBlockAndItem("blue_mushroom",
                    () -> new MushroomBlock(
                            BlockBehaviour.Properties.copy(Blocks.RED_MUSHROOM)
                                    .noCollission()
                                    .randomTicks()
                                    .instabreak()
                                    .sound(SoundType.GRASS),
                            () -> ModConfiguredFeatures.BLUE_MUSHROOM.getHolder().get()
                    ));

    public static final RegistryObject<Block> PURPLE_MUSHROOM =
            registerBlockAndItem("purple_mushroom",
                    () -> new MushroomBlock(
                            BlockBehaviour.Properties.copy(Blocks.RED_MUSHROOM)
                                    .noCollission()
                                    .randomTicks()
                                    .instabreak()
                                    .sound(SoundType.GRASS),
                            () -> ModConfiguredFeatures.PURPLE_MUSHROOM.getHolder().get()
                    ));

    public static final RegistryObject<Block> PINK_MUSHROOM =
            registerBlockAndItem("pink_mushroom",
                    () -> new MushroomBlock(
                            BlockBehaviour.Properties.copy(Blocks.RED_MUSHROOM)
                                    .noCollission()
                                    .randomTicks()
                                    .instabreak()
                                    .sound(SoundType.GRASS),
                            () -> ModConfiguredFeatures.PINK_MUSHROOM.getHolder().get()
                    ));
