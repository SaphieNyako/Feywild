...
public class AutumnPixieRenderer extends GeoEntityRenderer<AutumnPixieEntity> {
    ...
    @Override
    public RenderType getRenderType(AutumnPixieEntity animatable, float partialTicks, MatrixStack stack, @Nullable IRenderTypeBuffer renderTypeBuffer, @Nullable IVertexBuilder vertexBuilder, int packedLightIn, ResourceLocation textureLocation) {
