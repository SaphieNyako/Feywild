...
public class SummerPixieRenderer extends GeoEntityRenderer<SummerPixieEntity> {
    ...
    @Override
    public RenderType getRenderType(SummerPixieEntity animatable, float partialTicks, MatrixStack stack, @Nullable IRenderTypeBuffer renderTypeBuffer, @Nullable IVertexBuilder vertexBuilder, int packedLightIn, ResourceLocation textureLocation) {
