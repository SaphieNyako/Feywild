...
public class WinterPixieRenderer extends GeoEntityRenderer<WinterPixieEntity> {
    ...
    public WinterPixieRenderer(EntityRendererProvider.Context renderManager) {
        super(renderManager, new WinterPixieModel());
        this.shadowRadius = 0.50f;
    }

    @Override
    public RenderType getRenderType(WinterPixieEntity animatable, float partialTick, PoseStack poseStack, @Nullable MultiBufferSource bufferSource, @Nullable VertexConsumer buffer, int packedLight, ResourceLocation texture) {
