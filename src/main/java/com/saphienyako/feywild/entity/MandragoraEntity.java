...
import com.saphienyako.feywild.entity.goals.guardians_goals.SingGoal;
...
public class MandragoraEntity extends FeyBase implements GroundEntity, ITradeable {
    ...
    public ItemLike getDismissItem() {
        return ModItems.SUMMONING_SCROLL_MANDRAGORA.get();
    }
    ...
    public void setVariant(MandragoraVariant variant) {this.entityData.set(VARIANT, variant.ordinal());}
