...
public class SpriteAngryGoal extends Goal {

    protected final Level level;
    protected final SpriteEntity entity;
    private int ticksLeft = 0;

    public SpriteAngryGoal(SpriteEntity sprite) {
        this.entity = sprite;
    ...
    private void emotion() {
        this.entity.setState(SpriteEntity.State.ANGRY);
    }
    ...
    public boolean canUse() {
        return this.entity.getState() == SpriteEntity.State.IDLE
                && level.random.nextFloat() < 0.2f &&  this.entity.getState() != SpriteEntity.State.HAPPY;
    }
