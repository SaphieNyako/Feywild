...
public class PhysicalAttackGoal extends Goal {
   ...
   @Nullable
    ...
    private void performAttack(LivingEntity target) {
        ...
        target.hurt(DamageSource.mobAttack(entity), ATTACK_DAMAGE);
    ...
    private void spawnTeleportEffect(ServerLevel serverLevel, double x, double y, double z) {
        ...
        FeywildNetwork.sendToTrackingEntity(new ParticleMessage(ParticleMessage.Type.DANDELION_FLUFF, new BlockPos(x, y, z)), entity);
