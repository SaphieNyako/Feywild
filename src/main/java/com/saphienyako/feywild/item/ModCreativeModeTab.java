    ...
    public static final RegistryObject<CreativeModeTab> FEYWILD_TAB = CREATIVE_MODE_TAB.register("feywild_tab",
            () -> CreativeModeTab.builder().icon(() -> new ItemStack(ModItems.SUMMONING_SCROLL_SPRING_PIXIE.get()))
                    ...
                    .displayItems((parameters, output) -> {
                        ...
                        output.accept(ModBlocks.ELVEN_QUARTZ_BLOCK.get().asItem());
                        ...
                        output.accept(ModBlocks.SUMMER_TREE_SAPLING.get().asItem());
                        ...
                        output.accept(ModBlocks.SUMMER_TREE_CRACKED_LOG.get());
                        ...
                        output.accept(ModBlocks.SUMMER_TREE_STRIPPED_WOOD_SLAB.get());
                        output.accept(ModBlocks.SUMMER_TREE_STRIPPED_WOOD_STAIRS.get());
                        output.accept(ModBlocks.SUMMER_TREE_STRIPPED_WOOD_WALL.get());
                        ...
                        output.accept(ModBlocks.SPRING_TREE_SAPLING.get().asItem());
                        ...
                        output.accept(ModBlocks.SPRING_TREE_CRACKED_LOG.get());
                        ...
                        output.accept(ModBlocks.SPRING_TREE_STRIPPED_WOOD_SLAB.get());
                        output.accept(ModBlocks.SPRING_TREE_STRIPPED_WOOD_STAIRS.get());
                        output.accept(ModBlocks.SPRING_TREE_STRIPPED_WOOD_WALL.get());
                        ...
                        output.accept(ModBlocks.WINTER_TREE_SAPLING.get().asItem());
                        ...
                        output.accept(ModBlocks.WINTER_TREE_CRACKED_LOG.get());
                        ...
                        output.accept(ModBlocks.WINTER_TREE_STRIPPED_WOOD_SLAB.get());
                        output.accept(ModBlocks.WINTER_TREE_STRIPPED_WOOD_STAIRS.get());
                        output.accept(ModBlocks.WINTER_TREE_STRIPPED_WOOD_WALL.get());
                        ...
                        output.accept(ModBlocks.AUTUMN_TREE_SAPLING.get().asItem());
                        ...
                        output.accept(ModBlocks.AUTUMN_TREE_CRACKED_LOG.get());
                        ...
                        output.accept(ModBlocks.AUTUMN_TREE_STRIPPED_WOOD_SLAB.get());
                        output.accept(ModBlocks.AUTUMN_TREE_STRIPPED_WOOD_STAIRS.get());
                        output.accept(ModBlocks.AUTUMN_TREE_STRIPPED_WOOD_WALL.get());
