...
public class ModItems {
    ...
    public static final RegistryObject<Item> FEY_GEM = ITEMS.register("fey_gem", () -> new ToolTipBaseItem(new Item.Properties().tab(ModCreativeModeTab.FEYWILD_TAB),
            Component.translatable("message.feywild.fey_gem")));
    public static final RegistryObject<Item> MANDRAKE_ROOT = ITEMS.register("mandrake_root", () -> new ToolTipBaseItemNameBlockItem(ModBlocks.MANDRAKE_CROP.get(), new Item.Properties().tab(ModCreativeModeTab.FEYWILD_TAB),
            Component.translatable("message.feywild.mandrake_root")));
    public static final RegistryObject<Item> FEY_INK_BOTTLE = ITEMS.register("fey_ink_bottle", () -> new ToolTipBaseItem(new Item.Properties().tab(ModCreativeModeTab.FEYWILD_TAB),
    ...
    public static final RegistryObject<Item> SUMMONING_SCROLL_SHROOMLING = ITEMS.register("summoning_scroll_shroomling", () -> new SummoningScrollItem<>(new Item.Properties().tab(ModCreativeModeTab.FEYWILD_TAB),
            Component.translatable("message.feywild.summoning_scroll_shroomling")));
    public static final RegistryObject<Item> SUMMONING_SCROLL_MANDRAGORA = ITEMS.register("summoning_scroll_mandragora", () -> new SummoningScrollItem<>(new Item.Properties().tab(ModCreativeModeTab.FEYWILD_TAB),
    ...
    public static final RegistryObject<Item> SUMMONING_SCROLL_OBERON = ITEMS.register("summoning_scroll_oberon", () -> new BossSummoningScrollItem(new Item.Properties().tab(ModCreativeModeTab.FEYWILD_TAB),
            Component.translatable("message.feywild.summoning_scroll_oberon")));

    public static final RegistryObject<Item> SUMMONING_SCROLL_ASHEN_LORD = ITEMS.register("summoning_scroll_ashen_lord", () -> new BossSummoningScrollItem(new Item.Properties().tab(ModCreativeModeTab.FEYWILD_TAB),
    ...
    public static final RegistryObject<Item> MANDRAKE = ITEMS.register("mandrake", () -> new ToolTipBaseItem(new Item.Properties().tab(ModCreativeModeTab.FEYWILD_TAB).food(
    ...
    public static final RegistryObject<Item> SPAWN_EGG_SPRING_PIXIE = ITEMS.register("spawn_egg_spring_pixie", () -> new ForgeSpawnEggItem(ModEntities.SPRING_PIXIE, 0xf085a9, 0xa1db67, new Item.Properties().tab(ModCreativeModeTab.FEYWILD_TAB)));
    public static final RegistryObject<Item> SPAWN_EGG_AUTUMN_PIXIE = ITEMS.register("spawn_egg_autumn_pixie", () -> new ForgeSpawnEggItem(ModEntities.AUTUMN_PIXIE,0xb73737, 0xa56259, new Item.Properties().tab(ModCreativeModeTab.FEYWILD_TAB)));
    public static final RegistryObject<Item> SPAWN_EGG_SUMMER_PIXIE = ITEMS.register("spawn_egg_summer_pixie", ()-> new ForgeSpawnEggItem(ModEntities.SUMMER_PIXIE,0xf38807, 0xfedc5a, new Item.Properties().tab(ModCreativeModeTab.FEYWILD_TAB)));
    public static final RegistryObject<Item> SPAWN_EGG_WINTER_PIXIE = ITEMS.register("spawn_egg_winter_pixie", ()-> new ForgeSpawnEggItem(ModEntities.WINTER_PIXIE,0x84b4be, 0x323c81, new Item.Properties().tab(ModCreativeModeTab.FEYWILD_TAB)));
    ...
    public static final RegistryObject<Item> SPAWN_EGG_OBERON = ITEMS.register("spawn_egg_oberon", () -> new ForgeSpawnEggItem(ModEntities.OBERON,0xf085a9, 0xa1db67, new Item.Properties().tab(ModCreativeModeTab.FEYWILD_TAB)));

    public static final RegistryObject<Item> SPAWN_EGG_ASHEN_LORD = ITEMS.register("spawn_egg_ashen_lord", () -> new ForgeSpawnEggItem(ModEntities.ASHEN_LORD,0xb73737, 0xa56259, new Item.Properties().tab(ModCreativeModeTab.FEYWILD_TAB)));
