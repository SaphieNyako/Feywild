...
public class ModItems {
    ...
    public static final RegistryObject<Item> MANDRAKE_ROOT = ITEMS.register("mandrake_root", () -> new ItemNameBlockItem(ModBlocks.MANDRAKE_CROP.get(), new Item.Properties().tab(ModCreativeModeTab.FEYWILD_TAB)));
