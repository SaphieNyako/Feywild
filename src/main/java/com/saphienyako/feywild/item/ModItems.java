...
public class ModItems {
    ...
    public static final RegistryObject<Item> PIXIE_WING_TIARA =  ITEMS.register("pixie_wing_tiara", () -> new ExplosionProofItem(new Item.Properties(),
            Component.translatable("message.feywild.pixie_wing_tiara")));


    public static final RegistryObject<Item> AUTUMN_PIXIE_WING_TIARA =
            ITEMS.register("autumn_pixie_wing_tiara", () -> new PixieWingTiaraItem(new Item.Properties(),
    ...
    public static final RegistryObject<Item> SPRING_PIXIE_WING_TIARA =
            ITEMS.register("spring_pixie_wing_tiara", () -> new PixieWingTiaraItem(new Item.Properties(),
    ...
    public static final RegistryObject<Item> SUMMER_PIXIE_WING_TIARA =
            ITEMS.register("summer_pixie_wing_tiara", () -> new PixieWingTiaraItem(new Item.Properties(),
    ...
    public static final RegistryObject<Item> WINTER_PIXIE_WING_TIARA =
            ITEMS.register("winter_pixie_wing_tiara", () -> new PixieWingTiaraItem(new Item.Properties(),
    ...
    public static final RegistryObject<Item> SHADOW_WING_TIARA =
            ITEMS.register("shadow_wing_tiara", () -> new PixieWingTiaraItem(new Item.Properties(),
    ...
    public static final RegistryObject<Item> LIGHT_WING_TIARA =
            ITEMS.register("light_wing_tiara", () -> new PixieWingTiaraItem(new Item.Properties(),
    ...
    public static final RegistryObject<Item> SUMMONING_SCROLL_QUEEN_TITANIA = ITEMS.register("summoning_scroll_queen_titania", () -> new BossSummoningScrollItem(new Item.Properties(),
