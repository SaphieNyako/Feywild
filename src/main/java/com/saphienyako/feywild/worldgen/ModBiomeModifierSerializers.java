...
public class ModBiomeModifierSerializers {
    ...
    public static final DeferredRegister<Codec<? extends BiomeModifier>> BIOME_MODIFIER_SERIALIZERS =
            DeferredRegister.create(ForgeRegistries.Keys.BIOME_MODIFIER_SERIALIZERS, Feywild.MOD_ID);

    public static final RegistryObject<Codec<ConfigurableSpawnBiomeModifier>> FEYWILD_SPAWN_CODEC =
