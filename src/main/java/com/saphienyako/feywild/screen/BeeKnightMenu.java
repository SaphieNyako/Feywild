...
public class BeeKnightMenu extends AbstractContainerMenu {
    ...
    // Under MIT LICENSE
    public static BeeKnightMenu create(int i, Inventory inventory, FriendlyByteBuf buf) {
        ...
        BeeMountEntity beeMountEntity = beeMountEntities.isEmpty() ? null :beeMountEntities.get(0);
