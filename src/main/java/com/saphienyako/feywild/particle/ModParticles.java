...
public class ModParticles {
    ...
    public static final RegistryObject<SimpleParticleType> HEXEN_SPARKLE_PARTICLE = PARTICLE_TYPES.register("hexen_sparkle_particle", ()-> new SimpleParticleType(true));
