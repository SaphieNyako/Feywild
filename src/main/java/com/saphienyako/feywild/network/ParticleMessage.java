                ...
                case FEY_HEART -> {
                    ...
                    for (int i = 0; i < 5; i++) {
                        level.addParticle(ParticleTypes.HEART, true,
                                this.pos.getX() - 0.3 + (0.6 * ran.nextDouble()),
                                y + (1.9 * ran.nextDouble()),
                                this.pos.getZ() - 0.3 + (0.6 * ran.nextDouble()),
                                0, 0, 0);
                    }
                }
                case CROPS_GROW -> {
                    for (int i = 0; i < 10; i++) {
                        level.addParticle(ParticleTypes.FLAME, true,
                                this.pos.getX() - 0.3 + (0.6 * ran.nextDouble()),
                                this.pos.getY() + (0.8 * ran.nextDouble()),
                                this.pos.getZ() - 0.3 + (0.6 * ran.nextDouble()),
                                0, 0, 0);
                    }
                }
                case MOB_COLLECT -> {
                    for (int i = 0; i < 20; i++) {
                        level.addParticle(ParticleTypes.SOUL_FIRE_FLAME, true,
                                this.pos.getX() - 0.3 + (0.9 * ran.nextDouble()),
                                this.pos.getY() + (1.2 * ran.nextDouble()),
                                this.pos.getZ() - 0.3 + (0.9 * ran.nextDouble()),
                                0, 0, 0);
                    }
                }
                case CROPS_RESET -> {
                    for (int i = 0; i < 10; i++) {
                        level.addParticle(ParticleTypes.GLOW, true,
                                this.pos.getX() - 0.3 + (0.6 * ran.nextDouble()),
                                this.pos.getY() + (0.8 * ran.nextDouble()),
                                this.pos.getZ() - 0.3 + (0.6 * ran.nextDouble()),
                                0, 0, 0);
