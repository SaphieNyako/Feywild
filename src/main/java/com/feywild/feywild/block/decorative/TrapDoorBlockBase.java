...
public class TrapDoorBlockBase extends TrapDoorBlock implements Registerable {
    ...
    public TrapDoorBlockBase(ModX mod, BlockBehaviour.Properties properties) {
        this(mod, properties, new Item.Properties());
    }

    public TrapDoorBlockBase(ModX mod, BlockBehaviour.Properties properties, Item.Properties itemProperties) {
        super(properties);
        this.mod = mod;
        if (mod.tab != null) {
        ...
        this.item = new BlockItem(this, itemProperties) {
            ...
            public void initializeClient(@Nonnull Consumer<IItemRenderProperties> consumer) {
                TrapDoorBlockBase.this.initializeItemClient(consumer);
            }
        };
    }
