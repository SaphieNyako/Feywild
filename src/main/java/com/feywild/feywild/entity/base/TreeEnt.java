...
public abstract class TreeEnt extends GroundFeyBase {
    ...
    protected void registerGoals() {
        ...
        this.targetSelector.addGoal(1, new TameCheckingGoal(this, false, new HurtByTargetGoal(this, Creeper.class)));
        this.targetSelector.addGoal(2, new TameCheckingGoal(this, false, new NearestAttackableTargetGoal<>(this, Player.class, true, entity -> this.alignment() != null && entity instanceof ServerPlayer player && QuestData.get(player).getAlignment() != this.alignment())));
