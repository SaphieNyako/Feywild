...
public class ModEntityTypes {
    ...
    public static final EntityType<BeeKnightEntity> beeKnight = EntityType.Builder.of(BeeKnightEntity::new, EntityClassification.CREATURE)
            .sized(0.7f, 1)
    ...
    public static final EntityType<ShroomlingEntity> shroomling = EntityType.Builder.of(ShroomlingEntity::new, EntityClassification.CREATURE)
            .sized(0.7f, 0.8f)
