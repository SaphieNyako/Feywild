...
public class WinterWorldTreeStructure extends BaseStructure {
    ...
    public final static int AVERAGE_DISTANCE_BETWEEN_CHUNKS = Config.WINTER_WORLD_TREE_CONFIG.getCachedDistance();
    public final static int MIN_DISTANCE_BETWEEN_CHUNKS = Config.WINTER_WORLD_TREE_CONFIG.getCachedMinDistance();
    public final static int SEED_MODIFIER = 890124567;
    private static final List<MobSpawnInfo.Spawners> STRUCTURE_CREATURES = ImmutableList.of(
            new MobSpawnInfo.Spawners(ModEntityTypes.winterPixie, 100, 4, 4)
    );
    private static final String MESSAGE_LOCATION = "Winter World Tree at: ";
    private static final String MESSAGE_POOL = "winter_world_tree/start_pool";
