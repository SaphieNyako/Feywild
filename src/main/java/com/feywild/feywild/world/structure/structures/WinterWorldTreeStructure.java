...
public class WinterWorldTreeStructure extends BaseStructure {
    ...
    public final static int AVERAGE_DISTANCE_BETWEEN_CHUNKS = Config.WINTER_WORLD_TREE_AVERAGE_DISTANCE.get();
    public final static int MIN_DISTANCE_BETWEEN_CHUNKS = Config.WINTER_WORLD_TREE_MIN_DISTANCE.get();
