...
public class HexenTreeFeature extends Feature<NoneFeatureConfiguration> {

    private static final ResourceLocation HEXEN_TREE_1 = new ResourceLocation("feywild:hexen_tree_1");
    private static final ResourceLocation HEXEN_TREE_2 = new ResourceLocation("feywild:hexen_tree_2");
    private static final ResourceLocation HEXEN_TREE_3 = new ResourceLocation("feywild:hexen_tree_3");
    private static final ResourceLocation HEXEN_TREE_4 = new ResourceLocation("feywild:hexen_tree_4");
    private static final ResourceLocation[] HEXEN_TREE = new ResourceLocation[]{HEXEN_TREE_1, HEXEN_TREE_2, HEXEN_TREE_3, HEXEN_TREE_4};


    public HexenTreeFeature() {
    ...
    public boolean place(FeaturePlaceContext<NoneFeatureConfiguration> context) {
        ...
        int randomTree = random.nextInt(HEXEN_TREE.length);
        ...
        StructureTemplate template = templatemanager.getOrCreate(HEXEN_TREE[randomTree]);
        ...
        Optional<StructureProcessorList> processor = ((Registry) reader.getLevel().getServer().registryAccess().registry(Registry.PROCESSOR_LIST).get()).getOptional(
                new ResourceLocation(FeywildMod.getInstance().modid, "hexen_tree_processor"));
