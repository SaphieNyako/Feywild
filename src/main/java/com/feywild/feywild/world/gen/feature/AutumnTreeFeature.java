...
public class AutumnTreeFeature extends Feature<NoneFeatureConfiguration> {
    ...
    public static final ResourceLocation AUTUMN_TREE_2 = new ResourceLocation("feywild:autumn_tree_2");
    public static final ResourceLocation AUTUMN_TREE_3 = new ResourceLocation("feywild:autumn_tree_3");
    public static final ResourceLocation AUTUMN_TREE_4 = new ResourceLocation("feywild:autumn_tree_4");
    public static final ResourceLocation AUTUMN_TREE_5 = new ResourceLocation("feywild:autumn_tree_5");
    public static final ResourceLocation AUTUMN_TREE_6 = new ResourceLocation("feywild:autumn_tree_6");
    public static final ResourceLocation AUTUMN_TREE_7 = new ResourceLocation("feywild:autumn_tree_7");
    public static final ResourceLocation AUTUMN_TREE_8 = new ResourceLocation("feywild:autumn_tree_8");
    public static final ResourceLocation[] AUTUMN_TREE = new ResourceLocation[]{AUTUMN_TREE_1, AUTUMN_TREE_2, AUTUMN_TREE_3, AUTUMN_TREE_4, AUTUMN_TREE_5, AUTUMN_TREE_6, AUTUMN_TREE_7, AUTUMN_TREE_8};


    public AutumnTreeFeature() {
    ...
    public boolean place(FeaturePlaceContext<NoneFeatureConfiguration> context) {
        ...
        int randomTree = random.nextInt(AUTUMN_TREE.length);
        ...
        StructureTemplate template = templatemanager.getOrCreate(AUTUMN_TREE[randomTree]);
        ...
        Optional<StructureProcessorList> processor = ((Registry) reader.getLevel().getServer().registryAccess().registry(Registry.PROCESSOR_LIST).get()).getOptional(
                new ResourceLocation(FeywildMod.getInstance().modid, "autumn_tree_processor"));
