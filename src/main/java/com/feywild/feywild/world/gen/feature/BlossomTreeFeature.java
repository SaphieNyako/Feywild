...
public class BlossomTreeFeature extends Feature<NoneFeatureConfiguration> {

    private static final ResourceLocation BLOSSOM_TREE_1 = new ResourceLocation("feywild:blossom_tree_1");
    private static final ResourceLocation BLOSSOM_TREE_2 = new ResourceLocation("feywild:blossom_tree_2");
    private static final ResourceLocation BLOSSOM_TREE_3 = new ResourceLocation("feywild:blossom_tree_3");
    private static final ResourceLocation[] BLOSSOM_TREE = new ResourceLocation[]{BLOSSOM_TREE_1, BLOSSOM_TREE_2, BLOSSOM_TREE_3};
    ...
    public boolean place(FeaturePlaceContext<NoneFeatureConfiguration> context) {
        ...
        int randomTree = random.nextInt(BLOSSOM_TREE.length);
        ...
        StructureTemplate template = templatemanager.getOrCreate(BLOSSOM_TREE[randomTree]);
        ...
        Optional<StructureProcessorList> processor = ((Registry) reader.getLevel().getServer().registryAccess().registry(Registry.PROCESSOR_LIST).get()).getOptional(
                new ResourceLocation(FeywildMod.getInstance().modid, "blossom_tree_processor"));
