...
public class SpringTreeFeature extends Feature<NoneFeatureConfiguration> {

    private static final ResourceLocation SPRING_TREE_1 = new ResourceLocation("feywild:spring_tree_1");
    private static final ResourceLocation SPRING_TREE_2 = new ResourceLocation("feywild:spring_tree_2");
    private static final ResourceLocation SPRING_TREE_3 = new ResourceLocation("feywild:spring_tree_3");
    private static final ResourceLocation SPRING_TREE_4 = new ResourceLocation("feywild:spring_tree_4");
    private static final ResourceLocation SPRING_TREE_5 = new ResourceLocation("feywild:spring_tree_5");
    private static final ResourceLocation SPRING_TREE_6 = new ResourceLocation("feywild:spring_tree_6");
    private static final ResourceLocation[] SPRING_TREE = new ResourceLocation[]{SPRING_TREE_1, SPRING_TREE_2, SPRING_TREE_3, SPRING_TREE_4, SPRING_TREE_5, SPRING_TREE_6};

    public SpringTreeFeature() {
    ...
    public boolean place(FeaturePlaceContext<NoneFeatureConfiguration> context) {
        ...
        int randomTree = random.nextInt(SPRING_TREE.length);
        ...
        StructureTemplate template = templatemanager.getOrCreate(SPRING_TREE[randomTree]);
        ...
        Optional<StructureProcessorList> processor = ((Registry) reader.getLevel().getServer().registryAccess().registry(Registry.PROCESSOR_LIST).get()).getOptional(
                FeywildMod.getInstance().resource("spring_tree_processor"));
