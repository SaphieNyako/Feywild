...
public class ModRecipeTypes {
    ...
    @NoReg
    public static final RecipeType<IAltarRecipe> ALTAR = RecipeType.register(IAltarRecipe.TYPE_ID.toString());
    @NoReg
    public static final RecipeType<IDwarvenAnvilRecipe> DWARVEN_ANVIL = RecipeType.register(IDwarvenAnvilRecipe.TYPE_ID.toString());

    @RegName("fey_altar")
    public static final AltarRecipe.Serializer ALTAR_SERIALIZER = new AltarRecipe.Serializer();
    @RegName("dwarven_anvil")
